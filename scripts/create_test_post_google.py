...
def create_test_post():
    """Создает тестовый пост и добавляет его в Google Sheets"""
...
#финтех #стартапы #инвестиции #бизнес #евгенийдубский #erartaai"""
    ...
    # Создаем экземпляр трекера Google Sheets
    tracker = GoogleSheetsTracker()
    
    # Добавляем статью в Google Sheets вместе с контентом
    article_id = tracker.add_article(article_data, article_content)
    print(f"Статья добавлена в Google Sheets с ID: {article_id}")
    
    # Добавляем русский пост в Google Sheets
    ...
    print(f"Русский пост добавлен в Google Sheets с ID: {russian_content_id}")
    
    # Добавляем английский пост в Google Sheets
    ...
    print(f"Английский пост добавлен в Google Sheets с ID: {english_content_id}")
    
    # Добавляем скрипт для Instagram Reel
    reel_id = tracker.add_reel(article_id, "TestStartup привлекает $5 миллионов", reel_script, 
                              "Тестовый скрипт для демонстрации хранения в Google Sheets")
    print(f"Скрипт для Instagram Reel добавлен в Google Sheets с ID: {reel_id}")
    ...
    russian_export_path = os.path.join(output_dir, "exported_russian_post_google.md")
    ...
    english_export_path = os.path.join(output_dir, "exported_english_post_google.md")
    ...
    print("\nВсе данные успешно добавлены в Google Sheets!")
    print(f"ID таблицы Google Sheets: {tracker.spreadsheet_id}")
